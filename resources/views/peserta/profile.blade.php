        ...
        <div class="card-body">
            <div style="display:flex;flex-direction:column;gap:0.75rem;">
                <div style="display:flex;justify-content:space-between;font-size:0.82rem;">
                    <span style="color:var(--gray-500);font-weight:500;">NPM</span>
                    <span style="font-weight:700;color:var(--navy);font-family:monospace;">{{ $user->npm_nip }}</span>
                </div>
                <div style="display:flex;justify-content:space-between;font-size:0.82rem;">
            ...
            <form method="POST" action="{{ route('peserta.profile.update') }}" enctype="multipart/form-data">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
                    ...
                    <div class="form-group" style="grid-column:1/-1;">
                        ...
                        <div class="form-hint">JPG/PNG, maks 1MB. Biarkan kosong jika tidak ingin diganti.</div>
                    </div>
                </div>
                ...
                <div style="font-size:0.85rem;font-weight:700;color:var(--navy);margin-bottom:1rem;">
                    <i class="ri-lock-password-line"></i> Ganti Password (Opsional)
                </div>
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
                    <div class="form-group" style="grid-column:1/-1;">

...
@section('page_title', 'Pembayaran Event')

@section('content')
<div class="page-header">
    <div>
        <h1 class="page-title">Pembayaran: {{ Str::limit($event->nama_event, 35) }}</h1>
        <p class="page-subtitle">Konfirmasi dan kelola pembayaran peserta</p>
    </div>
    <div style="display:flex;gap:0.75rem;">
        <a href="{{ route('panitia.rekening.index', $event->id_event) }}" class="btn btn-navy">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <span style="color:var(--gray-400);font-size:0.78rem;">
                                    {{ $p->metode === 'bayar_lokasi' ? 'Bayar di Lokasi' : 'Belum upload' }}
                                </span>
                            @endif
                        </td>
                        <td>
                            ...
                            @if($p->catatan_panitia)
                                <div style="font-size:0.68rem;color:var(--gray-500);margin-top:0.2rem;" title="{{ $p->catatan_panitia }}">
                        ...
                        <td>
                            ...
                            @elseif($p->status === 'dikonfirmasi')
                                <div style="color:var(--success);font-size:0.78rem;font-weight:600;">
                                    <i class="ri-checkbox-circle-line"></i> Terverifikasi
                                </div>
                            @else
                                <div style="color:var(--danger);font-size:0.78rem;font-weight:600;">
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="empty-state" style="padding:3rem;">
                                ...
                                <p>Pembayaran dari peserta akan muncul di sini.</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
    ...
    <div style="background:white;border-radius:var(--radius-xl);padding:2rem;width:90%;max-width:440px;box-shadow:var(--shadow-xl);">
        ...
        <form id="declineForm" method="POST">
            ...
            <div style="display:flex;gap:0.75rem;justify-content:flex-end;">
                ...
                <button type="submit" class="btn btn-danger"><i class="ri-close-circle-line"></i> Tolak</button>
            </div>
        </form>
    </div>
</div>
